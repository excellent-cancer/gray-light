...
function displayIndex (imgSize, spacing, left, imgs, index, flat, width, titleBox, vnode, first) {
  ...
  if (vnode.context.coverIndex !== index) {
    ...
    vnode.context.handleSelect(index)
  }
}
...
export default {
  bind: function (el, binding, vnode) {
    ...
    displayIndex(imgSize, spacing, el.scrollLeft, imgs, index, flat, parseInt(el.style.width), titleBox, vnode, true)
